...
///
/// \ingroup vtk
/// \class ttkCompareTriangulations
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the ttk::CompareTriangulations module.
///
/// This VTK filter uses the ttk::CompareTriangulations module to compute an averaging of
...
///   - standalone/CompareTriangulations/main.cpp
///
/// See the related ParaView example state files for usage examples within a
/// VTK pipeline.
///
/// \sa ttk::CompareTriangulations
/// \sa ttkAlgorithm

#pragma once

// VTK Module
#include <ttkCompareTriangulationsModule.h>
...
// TTK Base Includes
#include <CompareTriangulations.h>

class TTKCOMPARETRIANGULATIONS_EXPORT ttkCompareTriangulations
...
public:
   ...
   */
  static ttkCompareTriangulations *New();
  vtkTypeMacro(ttkCompareTriangulations, ttkAlgorithm);
...
protected:
   ...
   */
  ttkCompareTriangulations();
  ~ttkCompareTriangulations() override = default;
