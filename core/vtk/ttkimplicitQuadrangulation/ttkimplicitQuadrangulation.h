...
///
/// \ingroup vtk
/// \class ttkimplicitQuadrangulation
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the ttk::implicitQuadrangulation module.
///
/// This VTK filter uses the ttk::implicitQuadrangulation module to compute an averaging of
...
///   - standalone/implicitQuadrangulation/main.cpp
///
/// See the related ParaView example state files for usage examples within a
/// VTK pipeline.
///
/// \sa ttk::implicitQuadrangulation
/// \sa ttkAlgorithm

#pragma once

// VTK Module
#include <ttkimplicitQuadrangulationModule.h>
...
class TTKIMPLICITQUADRANGULATION_EXPORT ttkimplicitQuadrangulation
  : public ttkAlgorithm // we inherit from the generic ttkAlgorithm class
  ,
    protected ttk::implicitQuadrangulation // and we inherit from the base class
{
private:
  /**
...
public:
   ...
   */
  static ttkimplicitQuadrangulation *New();
  vtkTypeMacro(ttkimplicitQuadrangulation, ttkAlgorithm);
...
protected:
   ...
   */
  ttkimplicitQuadrangulation();
  ~ttkimplicitQuadrangulation() override = default;
