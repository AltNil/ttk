...
ZombieTriangulation::ZombieTriangulation()
...
int ZombieTriangulation::setInputGrid(const float &xOrigin,
                                        const float &yOrigin,
                                        const float &zOrigin,
...
int ZombieTriangulation::checkAcceleration() {
...
bool ZombieTriangulation::isPowerOfTwo(unsigned long long int v,
...
bool ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(isTriangleOnBoundary)(
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getVertexNeighbors)() {
...
/* SimplexId ZombieTriangulation::getVertexEdgeNumberInternal(
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::getVertexEdgesInternal() {
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::getVertexTrianglesInternal() {
...
SimplexId ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getVertexLinks)() {
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getVertexStars)() {
...
const vector<std::array<SimplexId, 2>> *
  ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getEdges)() {
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::getEdgeTrianglesInternal() {
...
SimplexId ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getEdgeLinkNumber)(
  const SimplexId &edgeId) const {
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getEdgeLinks)() {
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getEdgeStars)() {
...
int ZombieTriangulation::getTriangleEdgesInternal(
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::getTriangleEdgesInternal() {
...
const vector<std::array<SimplexId, 3>> *
  ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getTriangles)() {
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getTriangleLinks)() {
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getTriangleStars)() {
...
int ZombieTriangulation::getTriangleNeighbors(
...
int ZombieTriangulation::getTetrahedronEdges(
  vector<vector<SimplexId>> &edges) const {
...
int ZombieTriangulation::getTetrahedronTriangles(
...
int ZombieTriangulation::getTetrahedronNeighbors(
  vector<vector<SimplexId>> &neighbors) {
...
int ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getCellVertex)(
...
SimplexId ZombieTriangulation::getCellEdgeNumberInternal(
...
int ZombieTriangulation::getCellEdgeInternal(const SimplexId &cellId,
                                               const int &localEdgeId,
                                               SimplexId &edgeId) const {
  if(dimensionality_ == 3)
...
const vector<vector<SimplexId>> *ZombieTriangulation::getCellEdgesInternal() {
...
int ZombieTriangulation::getCellTriangleInternal(
  const SimplexId &cellId,
  const int &localTriangleId,
  SimplexId &triangleId) const {
  if(dimensionality_ == 3)
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::getCellTrianglesInternal() {
...
int ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getCellNeighbor)(
  const SimplexId &cellId,
  const int &localNeighborId,
  SimplexId &neighborId) const {
  if(dimensionality_ == 3)
...
const vector<vector<SimplexId>> *
  ZombieTriangulation::TTK_TRIANGULATION_INTERNAL(getCellNeighbors)() {
...
int ZombieTriangulation::preconditionVertexNeighborsInternal() {
